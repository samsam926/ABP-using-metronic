...
public class MongoDbBookDbSchemaMigrator : IBookDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbBookDbSchemaMigrator(IServiceProvider serviceProvider)
    {
