...
export declare class UsersComponent implements OnInit {
    ...
    constructor(list: ListService<GetIdentityUsersInput>, confirmationService: ConfirmationService, service: IdentityUserService, toasterService: ToasterService, fb: FormBuilder, injector: Injector);
    ngOnInit(): void;
    buildForm(): void;
    openModal(): void;
    add(): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<UsersComponent, "abp-users", never, {}, {}, never, never>;
}
