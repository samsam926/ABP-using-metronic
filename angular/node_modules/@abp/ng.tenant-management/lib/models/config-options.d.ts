...
export declare type TenantManagementEntityActionContributors = Partial<{
    [eTenantManagementComponents.Tenants]: EntityActionContributorCallback<TenantDto>[];
}>;
export declare type TenantManagementToolbarActionContributors = Partial<{
    [eTenantManagementComponents.Tenants]: ToolbarActionContributorCallback<TenantDto[]>[];
}>;
export declare type TenantManagementEntityPropContributors = Partial<{
    [eTenantManagementComponents.Tenants]: EntityPropContributorCallback<TenantDto>[];
}>;
export declare type TenantManagementCreateFormPropContributors = Partial<{
    [eTenantManagementComponents.Tenants]: CreateFormPropContributorCallback<TenantCreateDto>[];
}>;
export declare type TenantManagementEditFormPropContributors = Partial<{
